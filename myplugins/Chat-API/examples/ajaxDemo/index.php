...
$target = '628174977135'; //conversation target number/JID
?>
...
<script type="text/javascript">
    ...
    {
        $.ajax({
            url: "myplugins/Chat-API/examples/ajaxDemo/socket.php",
            cache: false,
            dataType: "html",
            timeout: 70000,
            method: "POST",
    ...
    {
        $.ajax({
            url: "myplugins/Chat-API/examples/ajaxDemo/ajax.php",
            cache: false,
            dataType: "json",
            method: "POST",
            data: {
